/*
* Este script, es para instalar en desarrollo con los datos de carga inicial
* para correr los scripts de modificación y probar el funcionamiento luego de sistema.
*/
